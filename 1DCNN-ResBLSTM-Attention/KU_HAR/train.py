...
from tensorflow.keras.layers import BatchNormalization, Dropout, LSTM, Dense, Activation, Bidirectional, Conv1D, \
    Flatten, AveragePooling1D, MaxPooling1D, LayerNormalization, Layer, Add
from tensorflow.keras.callbacks import ModelCheckpoint
from tensorflow.keras.utils import to_categorical
import tensorflow.keras.backend as K


model_save_path = 'D:/human activity recognition/ku_har/CNN_ResBLSTM_Attention.hdf5'
...
input = Input(shape=(300, 6))
model = CNN_ResBLSTM_Attention(input)
