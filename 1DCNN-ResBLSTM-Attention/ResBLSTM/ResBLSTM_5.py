...
model_save_path = 'D:/human activity recognition/UCI-HAR/ResBLSTM_5/Res_BLSTM.hdf5'
...
def ResBLSTM(input):
    ...
    output = Bidirectional(LSTM(64, return_sequences=False))(y_1)
    return output
...
ResBLSTM_history_file = open('Res_BLSTM_5.json', 'w')
